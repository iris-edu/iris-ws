...
public class TimeseriesChartTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			handler.reduce(false);
			List<TimeseriesBufferedImage> list = service.fetch(
					"http://service.iris.edu/fdsnws/dataselect/1/query?network=IU&station=ANMO&channel=*&location=00&starttime=2010-02-27T07:15:00&endtime=2010-02-27T07:30:00",
					null, null, handler);
