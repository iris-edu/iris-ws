...
public class Util {
	...
	public static long toLongTime(Btime bTime, byte activityFlags, int timeCorrection, byte microseconds) {
	...
	public static Timestamp toTime(Btime bTime, byte activityFlags, int timeCorrection, byte microseconds) {
		...
		long totalNanoSeconds = (microseconds * 1000) + (bTime.getTenthMilli() * 100000);
