 ...
 * 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA. A copy of the
 * GNU LGPL may be found at <code>http://www.gnu.org/copyleft/lesser.html</code>
 * </p>
 *
 ...
 *          inherit them (JDE) Fixed bug with calculation of nRows 15-Aug-2008 :
 *          Added scrunch.end() in writeImageData() method - see JFreeChart bug
 *          report 2037930 (David Gilbert);
 */
...
public class PngEncoder {
	...
	/**
	 * The compression level (1 = best speed, 9 = best compression, 0 = no
	 * compression).
	 */
	 ...
	 *
	 * @param level
	 *            the compression level (1 = best speed, 9 = best compression, 0
	 *            = no compression)
	 */
